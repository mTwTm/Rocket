...
public class MyPushListener implements PushListener {
    ...
    public void onPushNotificationReceived(Activity activity, PushNotification pushNotification) {
        ...
        if (message != null) {
            ...
            Toast.makeText(activity, String.format("Display a toast when a background push is clicked:", customData), Toast.LENGTH_LONG).show(); // For example R.string.push_toast would be "Push clicked with data=%1s"
        }
    }
};